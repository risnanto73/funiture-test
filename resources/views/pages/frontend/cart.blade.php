                        ...
                        <div class="flex flex-start flex-wrap items-center mb-4 -mx-4" data-row="1">
                            <div class="px-4 flex-none">
                                <div class="" style="width: 90px; height: 90px">
                                    <img src="{{ $item->produk->galleries()->exists() ? Storage::url($item->produk->galleries->first()->url) : 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mN88B8AAsUB4ZtvXtIAAAAASUVORK5CYII=' }}"
                            ...
                            <div class="px-4 w-auto flex-1 md:w-5/12">
                                <div class="">
                                    ...
                                    <h6 class="font-semibold text-base md:text-lg block md:hidden">
                                        IDR {{ number_format($item->produk->price) }}
                                    </h6>
                                </div>
                            </div>
                            <div class="px-4 w-auto flex-none md:flex-1 md:w-5/12 hidden md:block">
                                <div class="">
                                    <h6 class="font-semibold text-lg">IDR {{ number_format($item->produk->price) }}</h6>
                                </div>
                            </div>
                            <div class="px-4 w-2/12">
                                <div class="text-center">
                                ...
                                <div class="flex -mx-2 flex-wrap">
                                    <div class="px-2 w-6/12 h-24 mb-4">
                                        <button type="button" data-value="fedex" data-name="courier"
                                            ...
                                            <img src="{{ url('/frontend/images/content/logo-fedex.svg') }}" alt="Logo Fedex"
